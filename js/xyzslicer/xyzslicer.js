...
;(function() {
    ...
    // Constructor
    function XYZSlicer(settings) {
        // settings
        this.settings = _.defaults({}, settings || {}, XYZSlicer.i3dglblSettings);
    ...
    XYZSlicer.prototype.loadMesh = function(mesh) {
        // mesh
        this.mesh = mesh;
    ...
    XYZSlicer.prototype.getFaces = function(zPosition) {
        var time = Date.now();
    ...
    // global settings
    XYZSlicer.i3dglblSettings = i3dglblSettings;

    // export module
    xyzslicer.XYZSlicer = XYZSlicer;
